...
核心概念（与 CONTEXT.md 与 PRD「上下文装配」一节一致）：
...
from assembler_config import AssemblerConfig, BudgetOverride, load_assembler_config
from citation_reconciler import MARKER_PATTERN
from llm_config import RUNTIME_UNITS
from state import RevisionRound, WritingAgentState
